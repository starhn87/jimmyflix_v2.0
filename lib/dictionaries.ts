...
const dictionaries: Record<Locale, Dictionary> = {
  en: {
    ...
    header: {
      ...
      searchLabel: 'Search by title, person, or keyword',
      searchPlaceholder: 'Titles, people, keywords',
      searchButton: 'Search',
      searchEmptyError: 'Enter a title, person, or keyword.',
      darkMode: 'Dark mode',
      ...
      switchRegionKorea: 'Switch watch region to South Korea',
      switchRegionUnitedStates: 'Switch watch region to United States',
    },
    common: {
      untitled: 'Untitled',
    ...
    trend: {
      ...
      metadataDescription: 'Explore today’s and this week’s movie and TV Top 20, people in the spotlight, and older films and series back in the conversation.',
      eyebrow: 'TMDB trending',
      heading: 'What’s trending',
      description: 'Explore the Top 20, discover the people behind the stories, and revisit older films and series in the conversation.',
    ...
    search: {
      ...
      metadataDescription: 'Find people, movies, and TV shows by name, title, or topic on Jimmyflix.',
      noMatches: (query) => `No matches for “${query}”`,
      noMatchesHelp: 'Check the spelling, try a person’s full name, or use a short topic such as “time travel”.',
      showingOne: 'Showing 1 result',
      showingMany: (count) => `Showing ${count} results`,
      people: 'People',
      personResultsLabel: 'People search results',
      topics: 'Topics',
      ...
      intro: 'Use the search bar above to explore titles, people, and topics.',
      suggestionsLabel: 'Search suggestions',
      suggestions: ['Inception', 'Tom Hanks', 'time travel'],
      shorterTitle: 'Try a shorter search',
      shorterMessage: (max) => `Use up to ${max} characters for a title, person, or topic.`,
      clear: 'Clear search',
  ...
  ko: {
    ...
    header: {
      ...
      openSearch: '검색 열기',
      closeSearch: '검색 닫기',
      searchLabel: '제목, 인물 또는 키워드로 검색',
      searchPlaceholder: '제목, 인물, 키워드',
      searchButton: '검색',
      searchEmptyError: '제목, 인물 또는 키워드를 입력하세요.',
      darkMode: '다크 모드',
      ...
      region: '시청 국가',
      regionKorea: '대한민국',
      regionUnitedStates: '미국',
      switchRegionKorea: '시청 국가를 대한민국으로 변경',
      switchRegionUnitedStates: '시청 국가를 미국으로 변경',
    },
    common: {
      untitled: '제목 없음',
      yearUnknown: '연도 미상',
    ...
    trend: {
      metadataTitle: '트렌드',
      metadataDescription: '오늘과 이번 주의 영화·TV TOP 20, 주목받는 인물과 대표작, 다시 주목받는 작품을 만나보세요.',
      eyebrow: 'TMDB 트렌드',
      heading: '지금 뜨는 콘텐츠',
      description: '영화·TV TOP 20부터 주목받는 인물, 다시 주목받는 작품까지 만나보세요.',
    ...
    search: {
      metadataTitle: '검색',
      metadataDescription: 'Jimmyflix에서 인물, 영화, TV 프로그램을 이름, 제목 또는 주제로 찾아보세요.',
      noMatches: (query) => `“${query}” 검색 결과가 없습니다`,
      noMatchesHelp: '철자를 확인하거나 인물의 전체 이름, 또는 “시간 여행” 같은 짧은 주제어로 검색해 보세요.',
      showingOne: '검색 결과 1개를 찾았습니다',
      showingMany: (count) => `검색 결과 ${count}개를 찾았습니다`,
      people: '인물',
      personResultsLabel: '인물 검색 결과',
      topics: '주제',
      ...
      intro: '위 검색창에서 제목, 인물, 주제 키워드로 찾아보세요.',
      suggestionsLabel: '추천 검색어',
      suggestions: ['기생충', '송강호', '시간 여행'],
      shorterTitle: '검색어를 짧게 입력해 주세요',
      shorterMessage: (max) => `제목, 인물 또는 주제를 ${max}자 이내로 입력해 주세요.`,
      clear: '검색 지우기',
