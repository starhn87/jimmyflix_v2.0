...
| 브랜드 컬러 제안 | 문서화 완료 | 다크·라이트 대비를 검토한 세 가지 팔레트와 Ticket Cyan 권장안 |
...
- 브랜드 컬러는 Ticket Cyan, Marquee Amber, Velvet Violet 세 방향의 다크·라이트 토큰과 주요 대비를 비교했다. 기존 J 티켓의 인지 자산을 살리는 Ticket Cyan을 권장하며, 사용자 선택 전에는 실제 테마 토큰을 변경하지 않았다.
