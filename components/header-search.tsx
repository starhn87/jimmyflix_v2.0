  ...
  return (
    <>
      <button
        ...
        className="order-3 grid size-11 shrink-0 place-items-center rounded-full text-ink outline-none hover:bg-tone/8 focus-visible:ring-2 focus-visible:ring-accent max-[329px]:col-start-3 lg:hidden"
      >
